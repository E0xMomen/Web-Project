...
<body>
    ...
    <div class="container">
        <h1 class="soc">soc</h1>
        <div class="content">
            <pre class="brief">                        <span style="font-size: 50px;color: brown;">soc</span>    
                is a centralized function or team 
                responsible for improving an 
                organization’s cybersecurity posture 
                and preventing, detecting, and
                 responding to threats.</pre>
        </div>
        <table class="contain">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM books WHERE type='soc'";
        ...
        <form>
            ...
            border-radius: 20px;
            ">
                <a style="font-size: 20px; text-decoration: none; color: black; " href="addblog.php">add blog</a>
            </button>
        </form>
    </div>
    <footer>
